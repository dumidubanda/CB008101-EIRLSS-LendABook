...
public class BooksReservationsService implements CrudRepository<BookReservations> {
    ...
    private BooksReservationsRepository booksReservationsRepository;
    ...
    @Override
    public void deleteById(long id){ booksReservationsRepository.deleteById(id); }
    @Override
    public List<BookReservations> findAll(){
        return booksReservationsRepository.findAll();
    }
    @Override
    public Optional<BookReservations> findById(long id){ return booksReservationsRepository.findById(id); }
}
