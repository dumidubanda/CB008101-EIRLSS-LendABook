...
public class BookCategoriesController
{
    ...
    @PutMapping
    public BookCategories update(@Valid  @RequestBody BookCategories category){ return bookCategoriesService.save(category); }

    @DeleteMapping(path = "category/{id}")
    public void delete(@PathVariable("id") long id){ bookCategoriesService.deleteById(id); }

    @GetMapping
    public List<BookCategories> list(){ return bookCategoriesService.findAll(); }
}
