...
public class VideosReservationsService implements CrudRepository<VideoReservations> {
    ...
    private VideosReservationsRepository videosReservationsRepository;
    ...
    @Override
    public void deleteById(long id){ videosReservationsRepository.deleteById(id); }
    @Override
    public List<VideoReservations> findAll(){
        return videosReservationsRepository.findAll();
    }
    @Override
    public Optional<VideoReservations> findById(long id){ return videosReservationsRepository.findById(id); }
}
